...
#show: poster.with(
  ...
  authors: "Carlos H.C.A.Veras - 12547187, Pedro O.Torrente - 11798853",
  ...
  footer_email_ids: "pedrotorrente@usp.br, carlos.craveiro@usp.br",
  footer_color: "23477C",
...
Em 1966, Michael J. Flynn em seu artigo "_Very high-speed computing systems_" propôs a primeira versão de um sistema de classificação de arquiteturas para computadores de "alta performance", motivado pela diversidade dos computadores de alta performance voltados para aplicações científicas na época.
